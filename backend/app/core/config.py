...
class Settings(BaseSettings):
    ...
    ai_image_size: str = Field(default="2K", alias="AI_IMAGE_SIZE")
    ai_image_watermark: bool = Field(default=True, alias="AI_IMAGE_WATERMARK")
